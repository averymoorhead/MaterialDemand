...
# Step 1: Filter the dataframe for the years 2021 and 2030
...
# Ensure the dataframes are aligned correctly for each technology
...
# Check if df_2021 contains unique values per technology
if (any(duplicated(df_2021$variable))) {
  stop("df_2021 contains duplicate technologies.")
}

# Step 3: Perform the interpolation calculation for the year 2025
...
# Step 5: Calculate the new delta value for 2030
# Subtract the interpolated 2025 values from the 2030 values
...
#calculating mean capacities across models 
...
repeat_capacities_new <- bind_rows(repeat_capacities_new, new_rows)
