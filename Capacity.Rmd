...
#unique(input_capacities_delta$)

#Annualizing added capacities
repeat_capacities_new<- subset(repeat_capacities_new, year %in% c("2026","2030","2035"))

repeat_capacities_new$newval <- ifelse(repeat_capacities_new$year == 2026, repeat_capacities_new$newval / 2,
                                       ifelse(repeat_capacities_new$year == 2030, repeat_capacities_new$newval / 2,
                                              repeat_capacities_new$newval / 3))
