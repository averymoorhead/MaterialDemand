...
combined_plot <- p1 + geom_boxplot(data = aluminum_subset, aes(x = year, y = total_demand), fill = "gray", alpha = 0.5, width = 0.5) +
...
boxplot_ira <- ggplot(aluminum_subset, aes(x = year, y = total_demand)) +
  geom_boxplot(fill = "gray", alpha = 0.5, width = 0.5) +
  labs(x = "Year", y = "Total Demand for Aluminum (IRA)", title = "Box Plot of Total Demand for Aluminum (IRA)")
...
combined_plot <- p1 +
  geom_boxplot(data = aluminum_subset, aes(x = year, y = total_demand), fill = "gray", alpha = 0.5, width = 0.5) +
...
combined_plot <- p1 +
  geom_boxplot(data = aluminum_subset, aes(x = year - stagger_width, y = total_demand), fill = "gray", alpha = 0.5, width = 0.4) +
