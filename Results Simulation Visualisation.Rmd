...
# Save the combined plot as a PNG file
print(getwd())
ggsave("multimodelresultsplotREF.jpg", plot = final_plot_with_title, width = 10, height = 12, units = "in", dpi = 300)
...
# Save the combined plot as a PNG file
print(getwd())
ggsave("multimodelresultsplotIRA.jpg", plot = final_plot_with_title, width = 10, height = 12, units = "in", dpi = 300)
