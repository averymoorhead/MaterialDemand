...
aluminum_subset <- multi_model_mc_material_demand_total %>%
  ...
  select(-Coal, -Gas, -Hydro, -Nuclear.New, -onshore.wind, -utility.scale.solar.pv, -Coal.CCS,-Gas.CCS)
...
aluminum_subset_ira <- multi_model_mc_material_demand_total %>%
  ...
  mutate(
    ...
    total_demand = (Coal.CCS + Gas.CCS + onshore.wind + Hydro + Nuclear.New + utility.scale.solar.pv + Coal + Gas)/1000,
    year = 2035
  )
...
aluminum_subset_ref <- multi_model_mc_material_demand_total %>%
  ...
  mutate(
    ...
    Gas.CCS = sort(Gas.CCS),
    Coal.CCS = sort(Coal.CCS),
    total_demand = (Gas.CCS+ Coal.CCS + onshore.wind + Hydro + Nuclear.New + utility.scale.solar.pv + Coal + Gas)/1000,
    year= 2035
  )
