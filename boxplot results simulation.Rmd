...
for (material in materials) {
  ...
  p <- ggplot() +
    ...
    scale_color_manual(values = c("mean IRA" = "red", "min IRA" = "red", "max IRA" = "red",
                       ...
                       # Specifying linetypes for the legend
                       guide = guide_legend(override.aes = list(
                         linetype = c("solid", "dashed", "dotted", "solid", "dashed", "dotted")
                       ))) +
...
# Print the combined plot without legend
print(combined_plot)
ggsave("plswork_plot.jpg", plot = combined_plot, width = 10, height = 20, units = "in", dpi = 300)
